...
public class Main {
    public static void main(String[] args) {
        ...
        int contVenta4 = 0;
        int blockCaja = 0;
        int blockMenuVenta = 0;
        int blockMenuCompra = 0;
        ...
        double efectivoCaja = 0.00;
        double efectivoIngresado = 0.00;
        double margenGanancia = 0.00;
        double cantMaxTransferBanco = 0.00;
        char tipoCliente;
        char tipoProveedor;
        ...
        do {
            ...
            switch (opcionMenuPrincipal) {
                ...
                case 2:
                                    ...
                                    case 1:
                                        if (tipoCliente == 'A') {
                                            ...
                                            if (cantKilosProd1 >= 0) {
                                                ...
                                                efectivoCaja -= descVenta1; //decrementa ganancia
                    ...
                    } else if (blockMenuVenta == 1){
                        System.out.println(" *** Caja actualmente cerrada!!! ***");
                    }
                    break;
                    case 3:
                        if (blockMenuCompra == 0) {
                            System.out.println("Determine tipo de cliente: ");
                    ...
                    case 4: //Reportes
                        ...
                        margenGanancia = totalVenta - totalCompras;
                            System.out.println("||========================");
                            ...
                            System.out.println("|| El margen de ganancia es de: " + margenGanancia);
                            System.out.println("|| El valor medio de ventas es de: " + (totalVenta/numeroVentas));
                            System.out.println("|| El valor medio de compras es de: " + (totalCompras/numeroCompras));
                            ...
                            System.out.printf("|| Producto estrella del dia: %s%n", productoEstrella);
                            System.out.println("||========================\n");
                        break;
                    case 5: //Cierre de caja
                        System.out.println("***   C I E R R E  D E  C A J A   ***");
                        System.out.println("*************************************");
                        System.out.println("Cantidad actual de efectivo en caja: " + efectivoCaja);
                        System.out.println("*************************************");
                        System.out.println("Cuanto efectivo desea guardar en banco?: ");
                        double efectivoGuardar = read.nextDouble();
                        cantMaxTransferBanco = efectivoCaja * 0.6;
                        if (efectivoGuardar > cantMaxTransferBanco) {
                            System.out.println("La cantidad de efectivo no debe de ser \nmayor que el 60% del efectivo en caja");
                        } else {
                            System.out.println("Caja ha sido cerrada exitosamente!!");
                            efectivoCaja -= efectivoGuardar;
                            blockCaja = 1;
                            blockMenuCompra = 1;
                            blockMenuVenta = 1;
                            numeroVentas = 0;
                            ...
                            contVenta3 = 0;
                            contVenta4 = 0;
                            cantTotalKilosProd1 = 0.00;
                            cantTotalKilosProd2 = 0.00;
                            cantTotalKilosProd3 = 0.00;
                            cantTotalKilosProd4 = 0.00;
                            subtotalVenta1 = 0.00;
                            subtotalVenta2 = 0.00;
                            subtotalVenta3 = 0.00;
                            subtotalVenta4 = 0.00;
                            ...
                            descVenta3 = 0.00;
                            descVenta4 = 0.00;
                            subtotalCompras1 = 0.00;
                            subtotalCompras2 = 0.00;
                            subtotalCompras3 = 0.00;
                            subtotalCompras4 = 0.00;
                            cantTotalKilosCompras1 = 0.00;
                            cantTotalKilosCompras2 = 0.00;
                            cantTotalKilosCompras3 = 0.00;
                            cantTotalKilosCompras4 = 0.00;
                            totalCompras = 0.00;
                            ventaMayorGanancia = "";
                            compraMayorGasto = "";
                            productoEstrella = "";
